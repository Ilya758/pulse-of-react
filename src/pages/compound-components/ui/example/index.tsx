...
export const Example = () => (
  <>
    ...
    <Text mb="md">
      ...
      pattern. It supports both single and multiple open panels, uses context for state sharing, and
      is fully composed from subcomponents. All UI is styled with Mantine.
    </Text>
    <CodeHighlightTabs
      code={[
        {
